...
import {
  ...
  STORY_HOOK,
  STORY_PARAGRAPHS,
} from "@/content/story-meu-desamor-perfeito";
import coverImg from "@/assets/story-meu-desamor-perfeito-cover.jpg";
import inline1 from "@/assets/story-desamor-inline-1.jpg";
import inline2 from "@/assets/story-desamor-inline-2.jpg";
import inline3 from "@/assets/story-desamor-inline-3.jpg";
import inline4 from "@/assets/story-desamor-inline-4.jpg";
...
const INLINE_IMAGES: Record<number, { src: string; alt: string; caption?: string }> = {
  14: { src: inline1, alt: "Olivia parada diante da porta do banheiro", caption: "Três da madrugada. E uma porta fechada entre eles." },
  84: { src: inline2, alt: "Casal em lados opostos da cama king size", caption: "Cinco anos. A mesma cama. Mundos inteiros de distância." },
  159: { src: inline3, alt: "Olivia olhando o celular pela manhã", caption: "O algoritmo entregou o que ela mais temia ver." },
  264: { src: inline4, alt: "Carro estacionado em frente a restaurante de luxo", caption: "O carro era dele. O jantar, não era com ela." },
};
...
export const Route = createFileRoute("/meudesamorperfeito")({
